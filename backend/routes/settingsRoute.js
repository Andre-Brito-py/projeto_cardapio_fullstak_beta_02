...
import { getPixKey, updatePixKey, getSettings, updateBanner, getBanner, updateGoogleMapsSettings } from '../controllers/settingsController.js';
...
settingsRouter.post('/google-maps', identifyStore, authMultiTenant, requireStoreAdmin, addStoreContext, updateGoogleMapsSettings);
