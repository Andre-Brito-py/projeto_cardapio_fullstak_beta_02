...
const createStoreAndAdminFixed = async () => {
    try {
        console.log('🔌 Conectando ao MongoDB...');
        await mongoose.connect('mongodb://localhost:27017/mern-food-delivery-app');
        console.log('✅ Conectado ao MongoDB\n');

        // Buscar o super admin para usar como owner da loja
        ...
        if (!store) {
            ...
            store = new Store({
                ...
                slug: 'loja-demo',
                owner: superAdmin._id, // Usar super admin como owner
                settings: {
                    restaurantAddress: 'Rua Demo, 123 - Centro, São Paulo - SP',
                    address: {
                        street: 'Rua Demo',
                        number: '123',
                        neighborhood: 'Centro',
