...
const URLS = {
  ...
  FRONTEND_URL: 'http://localhost:5174', // Frontend onde roda a aplicação do cliente e garçom
  ADMIN_URL: 'http://localhost:5173',    // Admin onde roda o painel administrativo
